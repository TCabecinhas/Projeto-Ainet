                    ...
                    <div class="container mb-4">
                        <div class="row">
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 ">
                                <img src="{{ asset('storage/tshirt_images/' . $tshirt->imagem['image_url']) }}"
                                    class="img-fluid w-75 h-auto" alt="{{ $tshirt->imagem->name }}">
                            </div>
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                <form action="{{ route('tshirts.atualizar-tshirt-catalogo', $index) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control mb-4" min="1" step="1"
                                            value="{{ $tshirt->quantidade }}" id="number-quantidade" name="quantidade">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        @foreach ($cores as $cor)
                                            <div class="form-check form-check-inline">
                                                <input class="form-control form-check-input" type="radio"
                                                    name="cor_codigo" id="rd-cor_codigo" value="{{ $cor->code }}"
                                                    style="background-color: #{{ $cor->code }};color:#{{ $cor->code }};
                                                    height:2rem; width:2rem"
                                                    {{ $tshirt->cor_codigo == $cor->codigo ? 'checked' : '' }}>
                                            </div>
                                        @endforeach
                                    </div>
                                    <div class="form-group mt-4">
                                        ...
                                        <select class="form-control form-select" id="select-tamanho" name="tamanho"
                                            ...
                                            <option value="XS" {{ $tshirt->tamanho == 'XS' ? 'selected' : '' }}>XS
                                            </option>
                                            <option value="S" {{ $tshirt->tamanho == 'S' ? 'selected' : '' }}>S
                                            </option>
                                            <option value="M" {{ $tshirt->tamanho == 'M' ? 'selected' : '' }}>M
                                            </option>
                                            <option value="L" {{ $tshirt->tamanho == 'L' ? 'selected' : '' }}>L
                                            </option>
                                            <option value="XL" {{ $tshirt->tamanho == 'XL' ? 'selected' : '' }}>XL
                                            </option>
                                        </select>
                                    </div>
