                    ...
                    <div class="container mb-4">
                        <div class="row">
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12">
                                ...
                                <form action="{{ route('tshirts.adicionar-catalogo-carrinho', $tshirtImage) }}"
                                    @csrf
                                    @method('POST')
                                        ...
                                        @foreach ($colors as $color)
                                            <div class="form-check form-check-inline">
                                                <input class="form-control form-check-input" type="radio"
                                                    name="cor_codigo" id="rd-cor_codigo" value="{{ $color->codigo }}"
                                                    style="background-color: #{{ $color->codigo }};color:#{{ $color->codigo }};
